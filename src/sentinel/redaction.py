...
SENTINEL exists to stop sensitive data leaving via a tool call. If it then wrote
...
Redaction happens at span creation (:class:`~sentinel.forensics.emitter.SpanEmitter`),
