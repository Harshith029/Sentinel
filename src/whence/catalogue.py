...
Whence's provenance engine treats every tool RESULT as untrusted. But an MCP
...
itself an attack surface, and it is one Whence is uniquely placed to defend:
...
async def scan_descriptions(
    ...
    :class:`~whence.shield.InputShield`). Layer 1 is fallible by design — this
