"""The span emitter — Whence's single serialization point (BUILD_SPEC §2).
...
from whence.redaction import redact_payload
from whence.tracing import new_span_id_hex, new_trace_id_hex
